...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(auth -> auth                                                        // define as regras de autorização para as solicitações HTTP.
                        .requestMatchers("/usuario/", "/usuario/create", "/usuario/{id}").permitAll()    // permite acesso a todas as solicitações que correspondem aos caminhos "/", "/user/save" e "/product/all".
